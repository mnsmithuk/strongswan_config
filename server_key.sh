...
strongswan pki --self --ca --lifetime 3650 --in private/strongswanKey.pem --type rsa --dn "C=UK, O=MNSMITHUK, CN=$CN" --outform pem > cacerts/strongswanCert.pem
